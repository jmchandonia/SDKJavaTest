...
public class SDKJavaTestClient {
     ...
     */
    public SDKJavaTestClient(URL url) {
     ...
     * validity.
     */
    public SDKJavaTestClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public SDKJavaTestClient(URL url, String user, String password) throws UnauthorizedException, IOException {
